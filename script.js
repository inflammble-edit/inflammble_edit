...
const WORKS = [
  ...
  },
  {
    ...
    runtime: '114분',
    festival: '편집 김상범',
    synopsis: '비상한 두뇌를 가졌지만 동생 동구 없이는 아무 데도 못 가는 형 세하, 뛰어난 수영실력을 갖췄지만 형 세하 없이는 아무것도 못 하는 동생 동구. 이들은 피 한 방울 섞이지 않았지만 20년 동안 한 몸처럼 살아온 특별한 형제다. 어느 날 형제의 보금자리 <책임의 집>을 운영하던 신부님이 돌아가시자 모든 지원금이 끊기게 되고, 각각 다른 장애를 가진 두 사람은 헤어질 위기에 처하고 만다. 세하는 <책임의 집>을 지키고 동구와 떨어지지 않기 위해 구청 수영장 알바생이자 취준생 미현을 수영코치로 영입하고, 동구를 수영대회에 출전시켜 사람들의 이목을 집중시키는 데 성공한다. 헤어지지 않을 수 있다는 희망을 본 것도 잠시, 예상치 못한 인물이 형제 앞에 등장하면서 형제는 새로운 위기를 겪게 되는데...',
  },  
              {
    id: 18,
