...
const WORKS = [
  ...
  },
  {
    ...
    runtime: '137분',
    festival: '편집 김상범, 김재범',
    synopsis: '택시운전사 만섭은 아내를 여의고 11살 딸을 키우며 어렵게 살림을 꾸리는 가장. 외국손님을 태우고 광주에 갔다 통금 전에 돌아오면 밀린 월세를 갚을 수 있는 거금 10만원을 준다는 말에 독일기자 피터를 태우고 영문도 모른 채 길을 나선다. 피터는 독일 공영방송 소속 기자로, 일본에서 ‘광주가 심상치 않다’는 말을 듣고 광주로 향한다. 어떻게든 택시비를 받아야 하는 만섭의 기지로 검문을 뚫고 겨우 들어선 광주. 위험하니 서울로 돌아가자는 만섭의 만류에도 피터는 대학생 재식과 황기사의 도움 속에 촬영을 시작하는데...',
  },  
                            {
    id: 27,
    image: 'images/gunham.jpg',
    year: 2017,
    title: '군함도',
    director: '류승완',
    role: 'featureassistant',
    ...
    runtime: '120분',
    festival: '편집 김상범, 김재범',
    synopsis: '범죄조직의 1인자를 노리는 재호와 세상 무서운 것 없는 패기 넘치는 신참 현수는 교도소에서 만나 서로에게 끌리고 끈끈한 의리를 다져간다. 출소 후, 함께 권력을 차지하기 위해 의기투합하던 중, 두 사람의 숨겨왔던 야망이 조금씩 드러나고, 서로에 대해 새로운 사실을 알게 되면서 그들의 관계는 흔들리기 시작하는데…',
  },  
                                {
    id: 28,
    image: 'images/sherif.jpg',
    year: 2017,
    title: '보안관',
    director: '김형주',
    role: 'featureassistant',
    ...
    runtime: '115분',
    festival: '편집 김상범, 김재범',
    synopsis: '과잉 수사로 잘리고 낙향한 전직 형사 대호. 보안관을 자처하며 바다만큼 드넓은 오지랖으로 기장 평화를 수호한다. 평화롭던 동네에 비치타운 건설을 위해 성공한 사업가 종진이 서울에서 내려온 그때, 인근 해운대에 마약이 돌기 시작한다. 종진의 모든 행보가 의심스러운 대호는 그를 마약사범으로 의심해 형사의 직감을 부르짖으며 처남 덕만을 조수로 나 홀로 수사에 나선다. 허나, 민심은 돈 많고 세련되고, 대호의 공격에도 그를 은인으로 모시는 겸손함까지 갖춘 종진에게로 옮겨간 지 오래. 대호는 점점 낙동강 오리알이 되는데…',
  },  
  {
    id: 29,
    ...
    runtime: '119분',
    festival: '편집 김상범, 김재범',
    synopsis: '대한민국을 뒤흔든 택시기사 살인사건 발생! 유일한 목격자였던 10대 소년 현우는 경찰의 강압적인 수사에 누명을 쓰고 10년을 감옥에서 보내게 된다 한편, 돈도 빽도 없이 빚만 쌓인 벼랑 끝 변호사 준영은 거대 로펌 대표의 환심을 사기 위한 무료 변론 봉사 중 현우의 사건을 알게 되고 명예와 유명세를 얻기에 좋은 기회라는 본능적 직감을 하게 된다. 그러나 실제로 현우를 만난 준영은 다시 한번 정의감에 가슴이 뜨거워지는 자신을 발견하게 되고 현우는 준영의 도움으로 다시 한번 세상을 믿어볼 희망을 찾게 되는데..',
  },  
    {
    id: 30,
    ...
    roleLabel: '단편영화 편집',
    runtime: '16분',
    festival: '제19회 미장센단편영화제 상영 (2017) <br> 제21회 부천국제판타스틱영화제 상영 (2017) <br> 제19회 뭄바이국제영화제 상영 (2017) <br> 제11회 대단한단편영화제 상영 (2017)',
    synopsis: '만화방에서 스포일러를 당한 주연은 스포일러 범인을 찾는 추리를 시작한다. 엉뚱하며 재치 넘치는 그래픽과 깨알 같은 잔재미, 예상치 못했던 단서들을 통해 영화광들에게는 심각한 범죄(?) 중 하나인 스포일러에 대해 말하는 경쾌한 코미디',
  },  
      {
    id: 31,
    ...
    roleLabel: '단편영화 편집',
    runtime: '15분',
    festival: '제16회 피렌체한국영화제 상영 (2018) <br> 제43회 서울독립영화제 상영 (2017) <br> 제5회 서울구로국제어린이영화제 단편부문 우수상 (2017) <br> 제21회 부천국제판타스틱 영화제 상영 (2017) <br> 제19회 정동진독립영화제 상영 (2017) <br> 제13회 제천국제음악영화제 상영 <br> 제11회 대단한단편영화제 상영 (2017) <br> 제9회 서울국제초단편영화제 상영 (2017) <br> 제12회 파리한국영화제 상영 (2017)',
    synopsis: '어느 날 갑자기 변성기가 찾아오면서 지승은 합창단 솔로 파트에서 밀려날 위기에 처한다. 영화는 변성기로 대표되는 소년의 육체적 변화를 통해 성장을 이야기한다. 몸의 변화가 주는 묘한 스릴, 두려움과 기대감이 공존하는 가운데 소년은 그렇게 조금씩 어른이 되어간다.',
  },  
        {
    id: 32,
    ...
    roleLabel: '단편영화 편집',
    runtime: '7분',
    festival: '제6회 서울국제어린이영화제 상영 (2018) <br> 제9회 서울국제초단편영화제 상영 (2017)',
    synopsis: '아이는 엄마의 반대에 주워온 강아지를 다시 버리게 된다.',
  },  
          {
    id: 33,
    image: 'images/plasticlove.jpg',
    year: 2016,
    title: '플라스틱 러브',
    director: '권항',
    role: 'short',
    roleLabel: '단편영화 편집',
    runtime: '12분',
    festival: '제21회 부천국제판타스틱영화제 상영 (2017) <br> 제12회 파리한국영화제 상영 (2017) <br> 제9회 서울국제초단편영화제 상영 (2017)',
    synopsis: '휴대폰은 은수와 은수의 사랑을 사랑하기로 마음먹는다. 하지만 은수는 휴대폰의 바람대로 살아가지 않는다. 휴대폰은 혼란스러워하지만, 계속해서 그녀를 사랑하기로 한다.',
  },  
            {
    id: 34,
    image: 'images/301401.jpg',
    year: 2016,
    title: '301/401',
    director: '조경호',
    role: 'short',
    roleLabel: '단편영화 편집',
    runtime: '15분',
    festival: '제12회 파리한국영화제 상영 (2017)',
    synopsis: '오늘도 요리를 망친 301은 401로 가는 계단에 오른다.',
  },  
              {
    id: 35,
    ...
    runtime: '13분',
    festival: '',
    synopsis: '초밥왕으로 이름을 날리던 일식 요리사가 쓰러지고 난 뒤 한 쪽 몸에 마비가 와서 더이상 요리를 하지 못한 채 낙향해서 산다. 아내의 죽음 3주년을 맞아 삶의 의미가 없다 생각한 그가 죽을 결심을 하고 독이 든 그의 마지막 초밥을 만든다. 아내의 제삿상에 초밥을 올리고 죽으려 하던 때, 자신이 끝내 반대하던 요리사의 길을 가기로 하며 부녀 사이의 연을 끊었던 막내 딸이 찾아온다.',
  },  
                {
    id: 36,
    image: 'images/',
    ...
    roleLabel: '단편영화 편집',
    runtime: '15분',
    festival: 'OBS <꿈꾸는 U> 상영',
    synopsis: '어머니를 여의고 아버지와 단둘이 남아 이삿짐을 꾸리고 있는 초등학생 진호. 그런데 자꾸만 리본을 묶지 못하는데…',
  },  
                  {
    id: 37,
    ...
    roleLabel: '단편영화 편집',
    runtime: '8분',
    festival: '제17회 정동진독립영화제 상영 (2015) <br> 제20회 인디포럼 상영 (2015) <br> 제15회 광주국제영화제 상영 (2015) <br> 제14회 대한민국청소년영화제 상영, 장려상 수상 (2014)',
    synopsis: '머리 위에 돼지털이 뿅! 하고 솟아나는 돼지털녀와 비행기보다 빠른 크루져 보드를 타는 남자의 이야기. 과외 선생님인 민희는 과외 여학생의 오빠를 남몰래 짝사랑하고 있다. 그를 의식해 과외하는 집에서 화장실을 억지로 참던 민희. 결국, 사건이 터지고 마는데…',
  },  
